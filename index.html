...
<head>
  ...
  <!-- pour un design flexible sur différents appareils (le viewport) - le width=... va faire en sorte que la taille s'adapte à l'écran & le initial-scale c'est pour définir le niveau de zoom initial-->
...
<body id="conteneur">
  ...
  <div class="echanges" id="echanges">
    ...
    <form action="serveur.php" method="post" enctype="multipart/form-data"> <!-- enctype c'est si l'utilisateur veut envoyer un fichier une photo  -->
...
<div>
  ...
  <footer class="footer" id="footer">
    ...
    <div class="reseaux">
      ...
      <a href="https://www.instagram.com/?hl=fr" target="_blank"><img src="images/instagram.png" alt="Instagram" title="Instagram" class="rs"/></a>

      <a href="https://www.facebook.com/" target="_blank"><img src="images/facebook.png" alt="Facebook" title="Facebook" class="rs"/></a>

      <a href="https://twitter.com/login?lang=fr" target="_blank"><img src="images/twitter.png" alt="Twitter" title="Twitter" class="rs"/></a>
